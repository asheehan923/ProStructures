...
export default function HeroSection() {
  return (
    <section className="relative bg-[var(--color-secondary)] text-white overflow-hidden">
      {/* Background texture / gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-[var(--color-primary-950)] opacity-90" />

      {/* Red accent bar at top */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-[var(--color-primary)]" />

      <div className="relative max-w-[var(--max-width-site)] mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
